...
class TestFeedApi(unittest.TestCase):
    ...
    def test_get_list_id_feed(self) -> None:
        """Test case for get_list_id_feed

        CustomList Manga feed
        """
        pass

    def test_get_user_follows_manga_feed(self) -> None:
        """Test case for get_user_follows_manga_feed
