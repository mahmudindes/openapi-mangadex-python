...
class TestAuthorCreate(unittest.TestCase):
    """AuthorCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthorCreate:
        """Test AuthorCreate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorCreate`
        """
        model = AuthorCreate()
        if include_optional:
            return AuthorCreate(
