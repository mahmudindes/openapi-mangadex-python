...
class ForumsApi:
    ...
    @validate_call
    def forums_thread_create(
        self,
        forums_thread_create_request: Optional[ForumsThreadCreateRequest] = None,
        ...
        :param forums_thread_create_request:
        :type forums_thread_create_request: ForumsThreadCreateRequest
        ...
        _param = self._forums_thread_create_serialize(
            forums_thread_create_request=forums_thread_create_request,
    ...
    @validate_call
    def forums_thread_create_with_http_info(
        self,
        forums_thread_create_request: Optional[ForumsThreadCreateRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ForumsThreadResponse]:
        """Create forums thread
    ...
    @validate_call
    def forums_thread_create_without_preload_content(
        self,
        forums_thread_create_request: Optional[ForumsThreadCreateRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _forums_thread_create_serialize(
        self,
        forums_thread_create_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if forums_thread_create_request is not None:
            _body_params = forums_thread_create_request
