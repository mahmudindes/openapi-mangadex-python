...
class ChapterApi:
    ...
    @validate_call
    def delete_chapter_id(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        ...
        _param = self._delete_chapter_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_chapter_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_chapter_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        _request_timeout: Union[
            None,
    ...
    def _delete_chapter_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_chapter(
        ...
        ids: Annotated[Optional[List[StrictStr]], Field(description="Chapter ids (limited to 100 per request)")] = None,
        title: Optional[StrictStr] = None,
        groups: Optional[List[StrictStr]] = None,
        uploader: Optional[Any] = None,
        manga: Optional[StrictStr] = None,
        ...
        :param offset:
        :type offset: int
        :param ids: Chapter ids (limited to 100 per request)
        :type ids: List[str]
        :param title:
        :type title: str
        :param groups:
        ...
        :param uploader:
        :type uploader: GetChapterUploaderParameter
        :param manga:
        :type manga: str
        :param volume:
        :type volume: GetChapterVolumeParameter
        :param chapter:
        :type chapter: GetChapterVolumeParameter
        ...
        _param = self._get_chapter_serialize(
            limit=limit,
            offset=offset,
            ids=ids,
            title=title,
    ...
    @validate_call
    def get_chapter_with_http_info(
        self,
        limit: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = None,
        offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Chapter ids (limited to 100 per request)")] = None,
    ...
    @validate_call
    def get_chapter_without_preload_content(
        self,
        limit: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = None,
        offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ids: Annotated[Optional[List[StrictStr]], Field(description="Chapter ids (limited to 100 per request)")] = None,
    ...
    def _get_chapter_serialize(
        ...
        if uploader is not None:
            ...
            _query_params.append(('uploader', uploader))
    ...
    def get_chapter_id(
        ...
        _param = self._get_chapter_id_serialize(
            id=id,
            includes=includes,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_chapter_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        includes: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_chapter_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        includes: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
    ...
    def put_chapter_id(
        ...
        chapter_edit: Annotated[Optional[ChapterEdit], Field(description="The size of the body is limited to 32KB.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param chapter_edit: The size of the body is limited to 32KB.
        :type chapter_edit: ChapterEdit
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_chapter_id_serialize(
            id=id,
    ...
    @validate_call
    def put_chapter_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        content_type: StrictStr,
        chapter_edit: Annotated[Optional[ChapterEdit], Field(description="The size of the body is limited to 32KB.")] = None,
    ...
    @validate_call
    def put_chapter_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Chapter ID")],
        content_type: StrictStr,
        chapter_edit: Annotated[Optional[ChapterEdit], Field(description="The size of the body is limited to 32KB.")] = None,
    ...
    def _put_chapter_id_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if chapter_edit is not None:
            _body_params = chapter_edit
