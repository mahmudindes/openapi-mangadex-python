...
class GetMangaChapterReadmarkers2200Response(BaseModel):
    """
    GetMangaChapterReadmarkers2200Response
    """ # noqa: E501
    result: Optional[StrictStr] = None
    data: Optional[GetMangaChapterReadmarkers2200ResponseData] = None
    __properties: ClassVar[List[str]] = ["result", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetMangaChapterReadmarkers2200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
