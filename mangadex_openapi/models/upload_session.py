...
class UploadSession(BaseModel):
    ...
    attributes: Optional[UploadSessionAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['upload_session']):
            raise ValueError("must be one of enum values ('upload_session')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": UploadSessionAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
