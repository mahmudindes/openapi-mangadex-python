...
class PutUploadSessionFile200Response(BaseModel):
    """
    PutUploadSessionFile200Response
    """ # noqa: E501
    result: Optional[StrictStr] = None
    errors: Optional[List[Error]] = None
    data: Optional[List[UploadSessionFile]] = None
    __properties: ClassVar[List[str]] = ["result", "errors", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [UploadSessionFile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
