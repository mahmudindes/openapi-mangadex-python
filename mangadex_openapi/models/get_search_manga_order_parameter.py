...
class GetSearchMangaOrderParameter(BaseModel):
    """
    ...
    followed_count: Optional[StrictStr] = Field(default=None, alias="followedCount")
    relevance: Optional[StrictStr] = None
    rating: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["title", "year", "createdAt", "updatedAt", "latestUploadedChapter", "followedCount", "relevance", "rating"]
    ...
    def updated_at_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('latest_uploaded_chapter')
    def latest_uploaded_chapter_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('followed_count')
    def followed_count_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "followedCount": obj.get("followedCount"),
