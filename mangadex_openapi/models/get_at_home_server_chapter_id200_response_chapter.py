...
class GetAtHomeServerChapterId200ResponseChapter(BaseModel):
    """
    GetAtHomeServerChapterId200ResponseChapter
    """ # noqa: E501
    hash: Optional[StrictStr] = None
    data: Optional[List[StrictStr]] = None
    data_saver: Optional[List[StrictStr]] = Field(default=None, alias="dataSaver")
    __properties: ClassVar[List[str]] = ["hash", "data", "dataSaver"]
