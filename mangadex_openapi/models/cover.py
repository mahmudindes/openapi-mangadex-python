...
class Cover(BaseModel):
    ...
    attributes: Optional[CoverAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['cover_art']):
            raise ValueError("must be one of enum values ('cover_art')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CoverAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
