...
class ScanlationGroup(BaseModel):
    """
    ScanlationGroup
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[ScanlationGroupAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['scanlation_group']):
            raise ValueError("must be one of enum values ('scanlation_group')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ScanlationGroupAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
