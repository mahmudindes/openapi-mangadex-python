...
class GetChapterOrderParameter(BaseModel):
    """
    ...
    chapter: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "publishAt", "readableAt", "volume", "chapter"]
    ...
    def publish_at_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('readable_at')
    def readable_at_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def volume_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def chapter_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
