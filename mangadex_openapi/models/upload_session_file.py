...
class UploadSessionFile(BaseModel):
    ...
    attributes: Optional[UploadSessionFileAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['upload_session_file']):
            raise ValueError("must be one of enum values ('upload_session_file')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": UploadSessionFileAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
