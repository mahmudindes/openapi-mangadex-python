...
class GetMangaAggregate200Response(BaseModel):
    """
    GetMangaAggregate200Response
    """ # noqa: E501
    result: Optional[StrictStr] = 'ok'
    volumes: Optional[Dict[str, GetMangaAggregate200ResponseVolumesValue]] = None
    __properties: ClassVar[List[str]] = ["result", "volumes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumes": dict(
                (_k, GetMangaAggregate200ResponseVolumesValue.from_dict(_v))
