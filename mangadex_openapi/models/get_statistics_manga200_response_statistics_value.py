...
class GetStatisticsManga200ResponseStatisticsValue(BaseModel):
    """
    GetStatisticsManga200ResponseStatisticsValue
    """ # noqa: E501
    comments: Optional[StatisticsDetailsComments] = None
    rating: Optional[GetStatisticsManga200ResponseStatisticsValueRating] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rating": GetStatisticsManga200ResponseStatisticsValueRating.from_dict(obj["rating"]) if obj.get("rating") is not None else None,
