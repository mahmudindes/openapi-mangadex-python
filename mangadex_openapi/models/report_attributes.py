...
class ReportAttributes(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["details", "objectId", "status", "createdAt"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['waiting', 'accepted', 'refused', 'autoresolved']):
            raise ValueError("must be one of enum values ('waiting', 'accepted', 'refused', 'autoresolved')")
        return value
