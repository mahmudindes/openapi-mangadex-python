...
class ChapterEdit(BaseModel):
    ...
    groups: Optional[Annotated[List[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(max_length=10)]] = None
    version: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["title", "volume", "chapter", "translatedLanguage", "groups", "version"]
