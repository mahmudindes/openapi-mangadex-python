...
class PostCaptchaSolveRequest(BaseModel):
    """
    
    """ # noqa: E501
    captcha_challenge: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="captchaChallenge")
    __properties: ClassVar[List[str]] = ["captchaChallenge"]
