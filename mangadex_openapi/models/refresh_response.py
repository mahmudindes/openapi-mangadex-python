...
class RefreshResponse(BaseModel):
    ...
    """ # noqa: E501
    result: StrictStr
    token: Optional[LoginResponseToken] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["result", "token", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": LoginResponseToken.from_dict(obj["token"]) if obj.get("token") is not None else None,
