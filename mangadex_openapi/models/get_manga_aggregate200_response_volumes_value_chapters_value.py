...
class GetMangaAggregate200ResponseVolumesValueChaptersValue(BaseModel):
    """
    GetMangaAggregate200ResponseVolumesValueChaptersValue
    """ # noqa: E501
    chapter: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    others: Optional[List[StrictStr]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["chapter", "id", "others", "count"]
