...
class GetStatisticsManga200ResponseStatisticsValueRating(BaseModel):
    """
    GetStatisticsManga200ResponseStatisticsValueRating
    """ # noqa: E501
    average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Will be nullable if no ratings has been done")
    ...
    __properties: ClassVar[List[str]] = ["average", "bayesian"]
