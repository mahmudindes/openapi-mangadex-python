...
class ScanlationGroupAttributes(BaseModel):
    ...
    alt_names: Optional[List[Dict[str, Annotated[str, Field(strict=True)]]]] = Field(default=None, alias="altNames")
    ...
    focused_language: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="focusedLanguage")
    locked: Optional[StrictBool] = None
    official: Optional[StrictBool] = None
    verified: Optional[StrictBool] = None
    inactive: Optional[StrictBool] = None
    ex_licensed: Optional[StrictBool] = Field(default=None, alias="exLicensed")
    publish_delay: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Should respected ISO 8601 duration specification: https://en.wikipedia.org/wiki/ISO_8601#Durations", alias="publishDelay")
    version: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    updated_at: Optional[StrictStr] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["name", "altNames", "website", "ircServer", "ircChannel", "discord", "contactEmail", "description", "twitter", "mangaUpdates", "focusedLanguage", "locked", "official", "verified", "inactive", "exLicensed", "publishDelay", "version", "createdAt", "updatedAt"]
    ...
    def publish_delay_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(P([1-9]|[1-9][0-9])D)?(P?([1-9])W)?(P?T(([1-9]|1[0-9]|2[0-4])H)?(([1-9]|[1-5][0-9]|60)M)?(([1-9]|[1-5][0-9]|60)S)?)?$", value):
            raise ValueError(r"must validate the regular expression /^(P([1-9]|[1-9][0-9])D)?(P?([1-9])W)?(P?T(([1-9]|1[0-9]|2[0-4])H)?(([1-9]|[1-5][0-9]|60)M)?(([1-9]|[1-5][0-9]|60)S)?)?$/")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if focused_language (nullable) is None
        # and model_fields_set contains the field
        if self.focused_language is None and "focused_language" in self.model_fields_set:
            _dict['focusedLanguage'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "focusedLanguage": obj.get("focusedLanguage"),
            "locked": obj.get("locked"),
            "official": obj.get("official"),
            "verified": obj.get("verified"),
            "inactive": obj.get("inactive"),
            "exLicensed": obj.get("exLicensed"),
