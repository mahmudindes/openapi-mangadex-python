...
class ForumsThreadResponse(BaseModel):
    """
    ForumsThreadResponse
    """ # noqa: E501
    result: Optional[StrictStr] = 'ok'
    response: Optional[StrictStr] = 'entity'
    data: Optional[ForumsThreadResponseData] = None
    __properties: ClassVar[List[str]] = ["result", "response", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": obj.get("response") if obj.get("response") is not None else 'entity',
            "data": ForumsThreadResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
