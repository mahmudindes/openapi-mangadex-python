...
class ScanlationGroupEdit(BaseModel):
    """
    ScanlationGroupEdit
    """ # noqa: E501
    ...
    focused_languages: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="focusedLanguages")
    inactive: Optional[StrictBool] = None
    locked: Optional[StrictBool] = None
    publish_delay: Optional[StrictStr] = Field(default=None, alias="publishDelay")
    version: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["name", "leader", "members", "website", "ircServer", "ircChannel", "discord", "contactEmail", "description", "twitter", "mangaUpdates", "focusedLanguages", "inactive", "locked", "publishDelay", "version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if focused_languages (nullable) is None
        # and model_fields_set contains the field
        if self.focused_languages is None and "focused_languages" in self.model_fields_set:
            _dict['focusedLanguages'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "focusedLanguages": obj.get("focusedLanguages"),
