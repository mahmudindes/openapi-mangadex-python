...
class MangaCreate(BaseModel):
    ...
    MangaCreate
    """ # noqa: E501
    title: Dict[str, Annotated[str, Field(strict=True)]]
    ...
    original_language: Annotated[str, Field(strict=True)] = Field(alias="originalLanguage")
    ...
    content_rating: StrictStr = Field(alias="contentRating")
