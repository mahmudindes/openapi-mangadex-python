...
class Login(BaseModel):
    ...
    Login
    """ # noqa: E501
    username: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = None
    email: Optional[StrictStr] = None
    password: Annotated[str, Field(min_length=8, strict=True, max_length=1024)]
