...
class Author(BaseModel):
    ...
    attributes: Optional[AuthorAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['author']):
            raise ValueError("must be one of enum values ('author')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": AuthorAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
