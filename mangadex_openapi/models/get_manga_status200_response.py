...
class GetMangaStatus200Response(BaseModel):
    """
    GetMangaStatus200Response
    """ # noqa: E501
    result: Optional[StrictStr] = 'ok'
    statuses: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["result", "statuses"]
    ...
    def statuses_validate_enum(cls, value):
        ...
        if value not in set(['reading', 'on_hold', 'plan_to_read', 'dropped', 're_reading', 'completed']):
            raise ValueError("must be one of enum values ('reading', 'on_hold', 'plan_to_read', 'dropped', 're_reading', 'completed')")
        return value
