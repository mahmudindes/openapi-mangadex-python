...
class ScanlationGroupResponse(BaseModel):
    """
    ScanlationGroupResponse
    """ # noqa: E501
    result: Optional[StrictStr] = None
    response: Optional[StrictStr] = 'entity'
    data: Optional[ScanlationGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ScanlationGroup.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
