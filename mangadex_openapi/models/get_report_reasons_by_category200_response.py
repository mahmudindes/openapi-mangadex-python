...
class GetReportReasonsByCategory200Response(BaseModel):
    """
    GetReportReasonsByCategory200Response
    """ # noqa: E501
    result: Optional[StrictStr] = 'ok'
    response: Optional[StrictStr] = 'collection'
    data: Optional[List[GetReportReasonsByCategory200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetReportReasonsByCategory200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "limit": obj.get("limit"),
