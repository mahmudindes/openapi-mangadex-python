...
class GetReportReasonsByCategory200ResponseDataInner(BaseModel):
    """
    GetReportReasonsByCategory200ResponseDataInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = 'report_reason'
    attributes: Optional[GetReportReasonsByCategory200ResponseDataInnerAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'report_reason',
            "attributes": GetReportReasonsByCategory200ResponseDataInnerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
