...
class TagAttributes(BaseModel):
    ...
    TagAttributes
    """ # noqa: E501
    name: Optional[Dict[str, Annotated[str, Field(strict=True)]]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "group", "version"]
    ...
    def group_validate_enum(cls, value):
        ...
        if value not in set(['content', 'format', 'genre', 'theme']):
            raise ValueError("must be one of enum values ('content', 'format', 'genre', 'theme')")
        return value
