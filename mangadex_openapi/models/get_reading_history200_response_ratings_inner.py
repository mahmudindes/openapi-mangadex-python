...
class GetReadingHistory200ResponseRatingsInner(BaseModel):
    """
    GetReadingHistory200ResponseRatingsInner
    """ # noqa: E501
    chapter_id: Optional[StrictStr] = Field(default=None, alias="chapterId")
    read_date: Optional[datetime] = Field(default=None, alias="readDate")
    __properties: ClassVar[List[str]] = ["chapterId", "readDate"]
