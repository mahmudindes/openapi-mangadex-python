...
class MappingId(BaseModel):
    ...
    attributes: Optional[MappingIdAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['mapping_id']):
            raise ValueError("must be one of enum values ('mapping_id')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": MappingIdAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
