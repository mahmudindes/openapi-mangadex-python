...
from mangadex_openapi.api_response import ApiResponse, T as ApiResponseT
import mangadex_openapi.models
from mangadex_openapi import rest
from mangadex_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/5.10.2.dev1/python'
